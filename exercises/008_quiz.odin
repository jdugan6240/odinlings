...
main :: proc() {
    ...
    */
    ...
    total_dist[1] = total_dist[1] * 69 // Is this how we reference the first value?

    /* Assuming each degree of longitude is approximately 53 miles apart */
    total_dist[2] = total_dist[2] * 53 // Is this how we reference the second value?

    fmt.printf("Our Viking longship must go {} miles north and {} miles west.", total_dist[1], total_dist[2])
}
